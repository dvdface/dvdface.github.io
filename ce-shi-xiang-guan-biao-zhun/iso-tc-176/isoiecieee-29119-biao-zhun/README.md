...
![input-process-output](../../../.gitbook/assets/image%20%28124%29.png)
...
![Equivalence Partition](../../../.gitbook/assets/image%20%28123%29.png)
...
为了解决多个参数的问题，引入了分类树；分类树把多个参数分成一个个分类，再把每个参数的取值分为一个个类型，再梳理输入和输出之间的关系；这个关系常常用判断表或者因果图来表示；
...
![NIST&#x5173;&#x4E8E;&#x7EC4;&#x5408;&#x6D4B;&#x8BD5;&#x8BBE;&#x8BA1;&#x7684;&#x7814;&#x7A76;](../../../.gitbook/assets/image%20%28125%29.png)
...
![&#x5E8F;&#x5217;&#x6A21;&#x578B;&#x793A;&#x610F;](../../../.gitbook/assets/image%20%28119%29.png)

操作序列模型的优点在于，一次操作可以覆盖多个功能模块，能模拟和外部系统\(比如用户\)的交互，容易发现和外部系统交互时产生的问题；

比如，发短信的操作序列需要用到通信模块，而飞行模式的操作序列也会操作通信模块，这个时候就容易产生冲突，就会考验系统对冲突的处理；
