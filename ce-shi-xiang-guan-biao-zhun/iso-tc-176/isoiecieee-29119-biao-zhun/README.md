...
* 概述了三层测试过程模型：
  * 为什么需要使用三层测试模型：
    * 最高级别的组织管理 大型组织为了保证测试的一致性，需要高层组织进行协调和管理；
    * 软件测试过程需要计划、监控和控制 软件测试受到各种约束\(预算、进度、风险、组织文化、用户期望、项目范围、基础能力\)；组织级别制定的通用策略不可能放之四海而皆准，需要裁剪和完善，因此需要软件测试管理过程；测试计划主要根据风险平衡资源与测试需求；
    * 
  * 三层测试过程模型有哪些：
