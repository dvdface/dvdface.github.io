...
在位流程的目标一般是保证系统达到一个可接收的可靠性、可用性程度；
...
组织测试政策设定了组织测试的上下文；组织层面应当识别组织层面的风险，去制定一些测试流程；

如，医疗行业软件必须遵从严格的质量标准，组织测试政策应当包含这类安全性的需求，从而减轻业务失效时不这样做对业务的影响；

组织测试策略应当寻求方法在测试流程中管理风险；

在上述的医疗软件的例子中，组织级的测试策略应当提供指导如何测试来应对法律法规的风险；

除此以外，组织级的测试策略还应当提供一套方法来在测试管理流程中应用风险管理；
